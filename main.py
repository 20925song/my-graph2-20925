...
try:
    ...
    # 그래프 1 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 영화가 얼마나 나왔는지 알수가 있다.")
    ...
    # 그래프 2 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 영화가 얼마나 흥행했는지 한눈에 알수가 있다.")
    ...
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 어떤 영화가 흥행하고 어떤 영화가 안흥행했는지 알수가 있다.")
    ...
    # 그래프 4 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 장르별 색으로 개봉후 얼마나 흥행했는지 알수가 있다")
    ...
    # 그래프 5 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 초대박흥행작이 있는지 없는지 있다면 얼마나 흥행헀는지를 알수가 있다.")
    ...
    # 그래프 6 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 버블의 크기로 영화가 얼마나 흥행했는지 알수가 있다.")
    ...
    # 그래프 7 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:**  각 장르별 어떤 나라가 어떤 종류의 영화를 많이 냈는지 알수가 있다.")
    ...
    # 그래프 8 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 직관적으로 얼마나 바꼈는지 막대그래프로 알수가 있다.")
