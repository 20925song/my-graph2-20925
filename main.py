...
try:
    ...
    # 그래프 1 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 영화가 얼마나 나왔는지 알수있다.")
    ...
    # 그래프 2 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 어떤 영화가 흥행했는지 한눈에 알수있다.")
    ...
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 어떤 영화가 많이 흥행한지 많이 안 흥행한지 알수가있다.")
    ...
    # 그래프 4 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 장르별 어떤 영화가 흥행했는지 색별로 알수가있가")
    ...
    # 그래프 5 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별 초대박 영화가 있는지 있다면 어떤 영화인지 알수가있다.")
    ...
    # 그래프 6 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 버블의 크기로 각 영화가 얼마나 흥행했는지 알수가있다.")
    ...
    # 그래프 7 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 각 장르별로 어떤 나라가 어떤 장르를 많이냈는지 알수가있다.")
    ...
    # 그래프 8 설명 및 인사이트 구역
    with st.container():
        st.info("💡 **이 그래프로 알 수 있는 것:** 막대 그래프로 얼마나 관객이 많은지 알수있다.")
